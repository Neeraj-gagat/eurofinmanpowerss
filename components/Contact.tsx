            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="text" id="name" className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-euro-blue-900 focus:border-transparent transition-shadow bg-slate-50" placeholder="John Doe" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Email Address</label>
                  <input type="email" id="email" className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-euro-blue-900 focus:border-transparent transition-shadow bg-slate-50" placeholder="john@example.com" />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="tel" id="phone" className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-euro-blue-900 focus:border-transparent transition-shadow bg-slate-50" placeholder="+1 234 567 890" />
                </div>
                <div>
                  ...
                  <input type="text" id="country" className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-euro-blue-900 focus:border-transparent transition-shadow bg-slate-50" placeholder="E.g., Germany" />
                </div>
              </div>

              <div>
                <label htmlFor="message" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Message</label>
                <textarea id="message" rows={4} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-euro-blue-900 focus:border-transparent transition-shadow bg-slate-50 resize-none" placeholder="Tell us about your career goals or recruitment needs..."></textarea>
              </div>
